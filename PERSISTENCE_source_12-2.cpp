...
void setup() {
  ...
  // Load saved settings
  preferences.begin("psyclock", false);
  showClock = preferences.getBool("showClock", false);
  Serial.printf("Loaded showClock: %s\n", showClock ? "true" : "false");
...
void handleToggleClock() {
  ...
  preferences.putBool("showClock", showClock);
  Serial.printf("Saved showClock: %s\n", showClock ? "true" : "false");
